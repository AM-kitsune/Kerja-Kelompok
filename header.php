...
<header>
  ...
  <nav class="navbar">
      <ul>
        ...
        <li><a href="tampilticket.php"class="nav-link">Pesan Admin</a></li>
        <li><a href="tampil_fdplus.php"class="nav-link">Logbook Feeding</a></li>
        <li><a href="tampil_logbook.php"class="nav-link">Laporan Feeding</a></li>
